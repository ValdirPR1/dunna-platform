...
import { Proponente } from "../types/proposta";

interface Props {
  dados: Proponente;
  onChange: (campo: keyof Proponente, valor: string) => void;
}

const inputClass =
  "w-full rounded-xl border border-slate-200 bg-slate-50 p-3.5 font-sans text-navy outline-none focus:border-gold";

const labelClass = "mb-1.5 block font-sans text-xs font-semibold uppercase tracking-wide text-slate-500";

export default function CamposProponente({ dados, onChange }: Props) {
  return (
