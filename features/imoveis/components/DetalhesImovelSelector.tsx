...
import { DETALHES_PADRAO } from "../constants/detalhesImovel";
import { iconeDoDetalhe } from "../constants/iconesDetalhes";
...
export default function DetalhesImovelSelector({
  selecionados,
  onChange,
}: Props) {
  ...
  const personalizados = selecionados.filter(
    (item) => !DETALHES_PADRAO.includes(item as any)
  );
